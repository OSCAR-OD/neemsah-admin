...
import AuthorityInformation from './RFQ/AuthorityInformation';
import ProjectInformation from './RFQ/ProjectInformation';
...
const CreateDailyVisitReportPage = () => {
  const { user } = useAuth();
  ...
  const renderStepContent = (step) => {
    switch (step) {
      case 0:
         return (
           <div>
             <AuthorityInformation control={methods.control} errors={methods.formState.errors} />
             <ProjectInformation control={methods.control} errors={methods.formState.errors} setFlagValue={setFlagValue} />
           </div>
         );
       case 1:
...
export default CreateDailyVisitReportPage;
