...
function BusinessListPage() {
  ...
  const handleAttachmentsSubmit = async (data, selectId) => {
    if (selectId?.length > 0) {
      ...
      if (res?.success) {
        ...
        toast.success(editShow ? "About Business Card Updated" : "About Business Card Added");
      } else {
  ...
  return (
    <Box>
      <PageHeader title={"About Business Card List"} handleAddClick={uploadMediaShowModal} />
      ...
      <DeleteAlertModal
        isOpen={deleteShow}
        modifyText={"About Business Card"}
