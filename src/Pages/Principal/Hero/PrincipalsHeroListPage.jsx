...
function PrincipalsHeroListPage() {
  ...
  const handleAttachmentsSubmit = async (data, selectId) => {
    if (selectId?.length > 0) {
      ...
      if (res?.success) {
        ...
        toast.success(editShow ? "Principals Hero Updated" : "Principals Hero Added");
      } else {
  ...
  return (
    <Box>
      <PageHeader title={"Principals Hero List"} handleAddClick={uploadMediaShowModal} />
...
export default PrincipalsHeroListPage;
