...
function RawmHeroPage() {
  ...
  const handleAttachmentsSubmit = async (data, selectId) => {
    if (selectId?.length > 0) {
      ...
      if (res?.success) {
        ...
        toast.success(editShow ? "Raw Materials Hero Updated" : "Raw Materials Hero Added");
      } else {
  ...
  return (
    <Box>
      <PageHeader title={"Raw Materials Hero List"} handleAddClick={uploadMediaShowModal} />
