...
function CustomersHeroListPage() {
  ...
  const handleAttachmentsSubmit = async (data, selectId) => {
    if (selectId?.length > 0) {
      ...
      if (res?.success) {
        ...
        toast.success(editShow ? "Customers Hero Updated" : "Customers Hero Added");
      } else {
  ...
  return (
    <Box>
      <PageHeader title={"Customers Page Hero List"} handleAddClick={uploadMediaShowModal} />
...
export default CustomersHeroListPage;
