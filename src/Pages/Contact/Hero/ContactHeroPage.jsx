...
import MediaHeroAllList from "../../../Components/Media/MediaHeroAllList";
...
function ContactHeroPage() {
  ...
  const handleAttachmentsSubmit = async (data, selectId) => {
    if (selectId?.length > 0) {
      ...
      if (res?.success) {
        ...
        toast.success(editShow ? "Contact Hero Updated" : "Contact Hero Added");
      } else {
  ...
  return (
    <Box>
      <PageHeader title={"Contact Hero List"} handleAddClick={uploadMediaShowModal} />
