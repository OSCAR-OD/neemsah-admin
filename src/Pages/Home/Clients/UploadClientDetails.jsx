...
function UploadClientDetails({ handleCancel, handleUploadSubmit }) {
  const [files, setFiles] = useState([]);
  //console.log("UploadClientDetails - files:", files);
    ...
    <Box component={"form"} onSubmit={handleSubmit(onSubmit)}>
      ...
      >
        ...
        <em style={{ fontSize: "14px" }}>
          (Only images and videos files upload){" "}
        </em>
...
export default UploadClientDetails;
