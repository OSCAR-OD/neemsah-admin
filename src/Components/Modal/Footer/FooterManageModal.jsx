...
function FooterManageModal({
  ...
  const getSingleItem = async () => {
    setIsLoading(true);
    const res = await getApiHandler(`/admin/${fetchPath}/singleFooterNav/${id}`);
...
FooterManageModal.defaultProps = {
  fetchPath: "footer",
  isShowButtonText: false,
};

export default FooterManageModal;
