...
function RawMaterialManageModal({
  isEditModal,
  handleFormSubmit,
  handleCancel,
  id,
            ...
            <Controller
              render={({ field, formState }) => (
                <FormControl fullWidth variant="outlined">
                  <Typography
                    variant="formLabel"
                    color={!!formState.errors?.tbName ? red[700] : ""}
                  >
                    Tab Name
                  </Typography>
                  <TextField
                    {...field}
                    error={!!formState.errors?.tbName}
                    placeholder="Tab Name"
                  />
                  {!!formState.errors?.tbName ? (
                    <FormHelperText error>
                      {errors?.tbName?.message}
                    </FormHelperText>
                  ) : (
                    ""
                  )}
            ...
            <Controller
              render={({ field, formState }) => (
                <FormControl fullWidth variant="outlined">
                  <Typography
                    variant="formLabel"
                    color={!!formState.errors?.tbTitle ? red[700] : ""}
                  >
                  Tab Title
                  </Typography>
                  <TextField
                    {...field}
                    error={!!formState.errors?.tbTitle}
                    placeholder="Tab Title"
                  />
                  {!!formState.errors?.tbTitle ? (
                    <FormHelperText error>
                      {errors?.tbTitle?.message}
                    </FormHelperText>
                  ) : (
                    ""
                  )}
...
RawMaterialManageModal.defaultProps = {
  fetchPath: "rawm",
  isShowButtonText: false,
};

export default RawMaterialManageModal;
