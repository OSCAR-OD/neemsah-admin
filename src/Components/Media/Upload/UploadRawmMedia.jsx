...
function UploadRawmMedia({ handleCancel, handleUploadSubmit }) {
  const [files, setFiles] = useState([]);
  //console.log("UploadRawmMedia - files:", files);
          ...
          <Controller
            render={({ field, formState }) => (
              <FormControl fullWidth variant="outlined">
                <Typography
                  variant="formLabel"
                  color={!!formState.errors?.corigin ? red[700] : ""}
                >
                Country of Origin
                </Typography>
                <TextField
                  {...field}
                  error={!!formState.errors?.corigin}
                  placeholder="Country of Origin"
                />
                {!!formState.errors?.corigin ? (
                  <FormHelperText error>
                    {errors?.corigin?.message}
                  </FormHelperText>
                ) : (
                  ""
                )}
...
export default UploadRawmMedia;
